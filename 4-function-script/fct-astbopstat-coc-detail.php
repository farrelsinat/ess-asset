...
$where = [];
if (!empty($status)) $where[] = "status_coc = '$status'";
...
// Query data
$sql = "SELECT jenis_bop, status_coc AS status, rig_operation, rig_yard, sn_bop, no_mov, size, pressure, no_coc FROM tb_dbhasilbop $whereClause ORDER BY jenis_bop ASC";
