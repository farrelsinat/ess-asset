...
<head>
  ...
  <title>ESS | BOP Edit Data Lokasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">EDIT DATA - BOP</a>
    </div>
  </nav>
    ...
    <div class="mb-3 row justify-content-center">
      ...
      <form id="dataForm" method="POST" action="pcs-astbop" enctype="multipart/form-data">
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_bop" name="sn_bop" readonly value="<?php echo $snbop; ?>">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="no_coc" name="no_coc">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <?php if (!empty($filecoc)) : ?>
                    <a href="<?php echo $filecoc; ?>" target="_blank">Lihat dokumen saat ini.</a>
                  <?php else : ?>
            ...
            if (snBOP) {
                fetch(`fct-astbopfedit.php?sn_bop=${snBOP}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('file_coc').value = data.file_coc || '';
                    })
