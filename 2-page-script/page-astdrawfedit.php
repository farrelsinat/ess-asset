...
<head>
  ...
  <title>ESS | DRAWWORKS Edit Data Lokasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">EDIT DATA - DRAWWORKS</a>
    </div>
  </nav>
    ...
    <div class="mb-3 row justify-content-center">
      ...
      <form id="dataForm" method="POST" action="pcs-astdraw">
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_dw" name="sn_dw" readonly value="<?php echo $sndw; ?>">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="legacy" name="legacy">
              </div>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        const snDWField = document.getElementById('sn_dw');
        if (snDWField.value) {
            fetchData(snDWField.value);
        }

        snDWField.addEventListener('input', function () {
