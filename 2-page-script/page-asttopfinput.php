...
<head>
  ...
  <title>ESS | TOP DRIVE Input Data</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #198754;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">INPUT DATA - TOP DRIVE</a>
    </div>
  </nav>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"  style="font-size: 1rem;">
          <p class="text">Sebelum melakukan input data, mohon pastikan data unit TOP DRIVE yang akan dimasukkan belum ada pada database untuk menghindari terjadinya duplikasi data.</p>
          <p class="text">Data unit TOP DRIVE yang akan dimasukkan dapat diperiksa terlebih dahulu pada database, dengan mencari melalui Serial atau Nomor Movable.</p>
          <p class="text">Jika data unit TOP DRIVE tersebut tidak ditemukan pada database, data tersebut aman untuk dimasukkan.</p>
      </div>
  ...
  <div class="container">
    <div class="mb-3 row justify-content-center">
        <div class="card bg-warning mb-3" style="width: 90%; font-weight: bold; border-width: 0px;">
            ...
            <span class="text-center mt-2">Mohon hindari kesamaan Serial dari TOP DRIVE yang akan ditambahkan dengan yang sudah ada pada database.</span>
      ...
      <form id="dataForm" method="POST" action="pcs-asttop">
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_top" name="sn_top" placeholder="Cth: TDS500THY/02">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="type" name="type" placeholder="Cth: Tesco 500">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="tonase" name="tonase" placeholder="Cth: 500">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="tahun_beli" name="tahun_beli" placeholder="Cth: 2015">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="status_top" name="status_top" placeholder="Cth: ON SITE">
              </div>
          </div>
