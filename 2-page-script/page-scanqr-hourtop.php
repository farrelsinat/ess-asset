...
<head>
  ...
  <title>ESS | TOP DRIVE Scan QR | Input Running Hours</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">RUNNING HOURS - TOP DRIVE</a>
    </div>
  </nav>
  ...
  <div class="container dashboard-section">
    <div class="card dashboard-card bg-danger" style="border-radius: 0px 0px 15px 15px;">
      <div class="dashboard-title text-white mb-2">Identitas Top Drive</div>
      <form action="fct-asttopfrh" method="POST" class="form-horizontal">
          <div class="tubular-specs mb-3">
              <label for="sn_top" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial
                  <input type="text" class="form-control" id="sn_top" name="sn_top" readonly>
              </label>
              <label for="type" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Tipe
                  <input type="text" class="form-control" id="type" name="type" readonly>
              </label>
              <label for="tonase" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Tonase
                  <input type="text" class="form-control" id="tonase" name="tonase" readonly>
              </label>
              <label for="status_top" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Status Unit
                  <input type="text" class="form-control" id="status_top" name="status_top" readonly>
              </label>
          </div>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="tableModalLabel">DB RUNNING HOURS - TOP DRIVE</h5>
            ...
            <div class="table-responsive">
              <table id="dt" class="table table-striped table-tertiary-color cell-border hover text-white" style="width: 100%;">
                ...
                <tbody>
                  ...
                  $sql = "SELECT sn_top, type, tonase, status_top, time_in, time_out, duration, total_duration, username FROM tb_dbhourstop";
          ...
          function startScanner(deviceId) {
              codeReader.decodeFromVideoDevice(deviceId, 'preview', (result, err) => {
                  if (result) {
                      ...
                      // Set the scanned result in the sn_top field
                      snTOPField.value = result.text;

                      // Dispatch input event to trigger fetchData
                      const inputEvent = new Event('input', { bubbles: true });
                      snTOPField.dispatchEvent(inputEvent);
  ...
  <script>
      document.addEventListener('DOMContentLoaded', function () {
          ...
          form.addEventListener('submit', function (event) {
              // Prevent submission if sn_top is empty
              if (!snTOPField.value.trim()) {
