...
<head>
  ...
  <title>ESS | DRAWWORKS Scan QR | Input Running Hours</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">RUNNING HOURS - DRAWWORKS</a>
    </div>
  </nav>
  ...
  <div class="container dashboard-section">
    <div class="card dashboard-card bg-danger" style="border-radius: 0px 0px 15px 15px;">
      <div class="dashboard-title text-white mb-2">Identitas Drawworks</div>
      <form action="fct-astdrawfrh" method="POST" class="form-horizontal">
          <div class="tubular-specs mb-3">
              <label for="sn_dw" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial
                  <input type="text" class="form-control" id="sn_dw" name="sn_dw" readonly>
              </label>
              ...
              <label for="legacy" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Legacy
                  <input type="text" class="form-control" id="legacy" name="legacy" readonly>
              </label>
          </div>
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="tableModalLabel">DB RUNNING HOURS - DRAWWORKS</h5>
            ...
            <div class="table-responsive">
              <table id="dt" class="table table-striped table-tertiary-color cell-border hover text-white" style="width: 100%;">
                ...
                <tbody>
                  ...
                  $sql = "SELECT sn_dw, man, type, legacy, time_in, time_out, duration, total_duration, username FROM tb_dbhoursdraw";
  ...
  <script>
      ...
      document.addEventListener('DOMContentLoaded', function () {
          ...
          function startScanner(deviceId) {
              codeReader.decodeFromVideoDevice(deviceId, 'preview', (result, err) => {
                  if (result) {
                      ...
                      // Set the scanned result in the sn_dw field
          ...
          function fetchData(snDraw) {
              if (snDraw) {
                  const loading = document.getElementById('loading');
                  loading.style.display = 'block'; // Show the spinner

                  fetch(`fct-astdrawfedit.php?sn_dw=${snDraw}`)
  ...
  <script>
      document.addEventListener('DOMContentLoaded', function () {
          ...
          form.addEventListener('submit', function (event) {
              // Prevent submission if sn_dw is empty
              if (!snDrawField.value.trim()) {
