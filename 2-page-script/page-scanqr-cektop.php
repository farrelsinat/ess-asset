...
<head>
  ...
  <title>ESS | TOP DRIVE Scan QR | Cek Spesifikasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">SPESIFIKASI - TOP DRIVE</a>
    </div>
  </nav>
  ...
  <div class="dashboard-wrapper">
    ...
    <div class="container dashboard-section">
      <div class="card dashboard-card bg-danger" style="border-radius: 0px 0px 15px 15px;">
        <div class="dashboard-title text-white mb-2">Spesifikasi Top Drive</div>
        <div class="tubular-specs">
          <label for="sn_top" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial<input type="text" class="form-control" id="sn_top" name="sn_top" readonly></label>
          ...
          <label for="tonase" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Tonase<input type="text" class="form-control" id="tonase" name="tonase" readonly></label>

          <label for="status_top" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Status Unit<input type="text" class="form-control" id="status_top" name="status_top" readonly></label>
  ...
  <script>
      ...
      document.addEventListener('DOMContentLoaded', function () {
          ...
          function clearFields() {
              ...
              document.getElementById('sn_top').value = '';
              document.getElementById('type').value = '';
              document.getElementById('tonase').value = '';
              document.getElementById('status_top').value = '';
