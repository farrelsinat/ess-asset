...
if(isset($_GET['edit'])){
  ...
  $query = "SELECT * FROM tb_dbhasilmpp WHERE id_mpp = '$id_mpp';";
...
<head>
  ...
  <title>ESS | MUD PUMP Input Data</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #198754;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">INPUT DATA - MUD PUMP</a>
    </div>
  </nav>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"  style="font-size: 1rem;">
          <p class="text">Sebelum melakukan input data, mohon pastikan data unit MUD PUMP yang akan dimasukkan belum ada pada database untuk menghindari terjadinya duplikasi data.</p>
          <p class="text">Data unit MUD PUMP yang akan dimasukkan dapat diperiksa terlebih dahulu pada database, dengan mencari melalui Serial atau Nomor Movable.</p>
          <p class="text">Jika data unit MUD PUMP tersebut tidak ditemukan pada database, data tersebut aman untuk dimasukkan.</p>
      </div>
  ...
  <div class="container">
    <div class="mb-3 row justify-content-center">
        <div class="card bg-warning mb-3" style="width: 90%; font-weight: bold; border-width: 0px;">
            ...
            <span class="text-center mt-2">Mohon hindari kesamaan Serial dari MUD PUMP yang akan ditambahkan dengan yang sudah ada pada database.</span>
            <span class="text-center mt-2 mb-3">Jika telah melakukan input data, harap hubungi PIC.</span>
        </div>
    </div>
      <form id="dataForm" method="POST" action="pcs-astmpp">
          <input type="hidden" value="<?php echo $id_mpp; ?>" name="id_mpp">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="sn_mpp" class="col-sm-2 col-form-label">Serial</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_mpp" name="sn_mpp" placeholder="Cth: 12476-H">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="no_mov" name="no_mov" placeholder="Cth: 01.87.0025">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="type" name="type" placeholder="Cth: 10P-130">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="man" name="man" placeholder="Cth: NOV">
              </div>
          </div>
          
          <div class="mb-3 row justify-content-center">
              <label for="status_mpp" class="col-sm-2 col-form-label">Status Unit</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="status_mpp" name="status_mpp" placeholder="Cth: ON SITE">
              </div>
          </div>
          ...
          <div class="mb-3 row mt-4 justify-content-center">
              <div class="col-sm-5 d-flex justify-content-center">
                  ...
                  <a href="page-astmppdtb.php" type="button" class="btn btn-danger">
