...
if(isset($_GET['edit'])){
  ...
  $query = "SELECT * FROM tb_dbhasildraw WHERE id_dw = '$id_dw';";
...
<head>
  ...
  <title>ESS | DRAWWORKS Input Data</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #198754;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">INPUT DATA - DRAWWORKS</a>
    </div>
  </nav>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"  style="font-size: 1rem;">
          <p class="text">Sebelum melakukan input data, mohon pastikan data unit DRAWWORKS yang akan dimasukkan belum ada pada database untuk menghindari terjadinya duplikasi data.</p>
          <p class="text">Data unit DRAWWORKS yang akan dimasukkan dapat diperiksa terlebih dahulu pada database, dengan mencari melalui Serial atau Nomor Movable.</p>
          <p class="text">Jika data unit DRAWWORKS tersebut tidak ditemukan pada database, data tersebut aman untuk dimasukkan.</p>
      </div>
  ...
  <div class="container">
    <div class="mb-3 row justify-content-center">
        <div class="card bg-warning mb-3" style="width: 90%; font-weight: bold; border-width: 0px;">
            ...
            <span class="text-center mt-2">Mohon hindari kesamaan Serial dari DRAWWORKS yang akan ditambahkan dengan yang sudah ada pada database.</span>
            <span class="text-center mt-2 mb-3">Jika telah melakukan input data, harap hubungi PIC.</span>
        </div>
    </div>
      <form id="dataForm" method="POST" action="pcs-astdraw">
          <input type="hidden" value="<?php echo $id_dw; ?>" name="id_dw">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="sn_dw" class="col-sm-2 col-form-label">Serial</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_dw" name="sn_dw" placeholder="Cth: T-2535">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="type" name="type" placeholder="Cth: N-80-B">
              </div>
          </div>
          
          <div class="mb-3 row justify-content-center">
              <label for="legacy" class="col-sm-2 col-form-label">Legacy</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="legacy" name="legacy" placeholder="Cth: COOPER">
              </div>
          </div>
          ...
          <div class="mb-3 row mt-4 justify-content-center">
              <div class="col-sm-5 d-flex justify-content-center">
                  ...
                  <a href="page-astdrawdtb.php" type="button" class="btn btn-danger">
