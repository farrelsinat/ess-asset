...
<head>
  ...
  <title>ESS | TUBULAR Scan QR | Cek Spesifikasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">SPESIFIKASI - TUBULAR</a>
    </div>
  </nav>
  ...
  <div class="dashboard-wrapper">
    ...
    <div class="container dashboard-section">
      <div class="card dashboard-card bg-danger" style="border-radius: 0px 0px 15px 15px;">
        <div class="dashboard-title text-white mb-2">Spesifikasi Tubular Goods</div>
        <div class="tubular-specs">
          <label for="sn_pin" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial PIN<input type="text" class="form-control" id="sn_pin" name="sn_pin" readonly></label>

          <label for="sn_box" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial BOX<input type="text" class="form-control" id="sn_box" name="sn_box" readonly></label>

          <label for="jenis_tubgod" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Jenis<input type="text" class="form-control" id="jenis_tubgod" name="jenis_tubgod" readonly></label>
          ...
          <label for="conn_type" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Tipe Koneksi<input type="text" class="form-control" id="conn_type" name="conn_type" readonly></label>

          <label for="pounder" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Pounder (ppf)<input type="text" class="form-control" id="pounder" name="pounder" readonly></label>

          <label for="weight" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Berat (kg)<input type="text" class="form-control" id="weight" name="weight" readonly></label>

          <label for="length" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Panjang (m)<input type="text" class="form-control" id="length" name="length" readonly></label>
  ...
  <script>
      ...
      document.addEventListener('DOMContentLoaded', function () {
              ...
              if (snPin) {
                  ...
                  fetch(`fct-asttubgodfedit.php?sn_pin=${snPin}`)
                      ...
                      .then(data => {
                          ...
                          document.getElementById('conn_type').value = data.conn_type || '';
                          document.getElementById('pounder').value = data.pounder || '';
          ...
          function clearFields() {
              ...
              document.getElementById('sn_pin').value = '';
              document.getElementById('sn_box').value = '';
              document.getElementById('jenis_tubgod').value = '';
              document.getElementById('man').value = '';
              document.getElementById('conn_type').value = '';
              document.getElementById('pounder').value = '';
