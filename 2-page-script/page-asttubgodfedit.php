...
<head>
  ...
  <title>ESS | TUBULAR Edit Data Lokasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">EDIT DATA - TUBULAR</a>
    </div>
  </nav>
  ...
  // Function to update the second dropdown based on the selection in the first
    function updateRigYardOptions() {
      ...
      rigYardSelect.innerHTML = '<option value="">Pilih Rig/Yard/WS</option>';
  ...
  <div class="container">
    <div class="mb-3 row justify-content-center">
        <div class="card bg-warning mb-3" style="width: 90%; font-weight: bold; border-width: 0px;">
            <span class="text-center mt-3">Apabila hendak melakukan perubahan lokasi joint, harap hanya mengubah kolom Lokasi dan Letak saja.</span>
            ...
            <span class="text-center mt-2 mb-3">Kolom Serial PIN tidak dapat diubah. Jika diyakini ada perubahan pada Serial PIN, harap hubungi PIC.</span>
        </div>
    </div>
      <form id="dataForm" method="POST" action="pcs-asttubgod">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="sn_pin" class="col-sm-2 col-form-label">Serial PIN</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_pin" name="sn_pin" readonly value="<?php echo $snpin; ?>">
              </div>
          </div>
          
          <div class="mb-3 row justify-content-center">
              <label for="sn_box" class="col-sm-2 col-form-label">Serial BOX</label>
              <div class="col-sm-5">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="jenis_tubgod" class="col-sm-2 col-form-label">Jenis</label>
              <div class="col-sm-5">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="conn_type" class="col-sm-2 col-form-label">Tipe Koneksi</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="conn_type" name="conn_type" readonly>
              </div>
          </div>
          
          <div class="mb-3 row justify-content-center">
              <label for="pounder" class="col-sm-2 col-form-label">Pounder (ppf)</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="pounder" name="pounder" readonly>
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              <label for="use_date" class="col-sm-2 col-form-label">Tanggal Pemakaian</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="use_date" name="use_date" readonly>
              </div>
          </div>
            ...
            if (snPin) {
                fetch(`fct-asttubgodfedit.php?sn_pin=${snPin}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('use_date').value = data.use_date || '';
