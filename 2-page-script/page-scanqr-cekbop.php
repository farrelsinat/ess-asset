...
<head>
  ...
  <title>ESS | BOP Scan QR | Cek Spesifikasi</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #0d6efd;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">SPESIFIKASI - BOP</a>
    </div>
  </nav>
  ...
  <div class="dashboard-wrapper">
    ...
    <div class="container dashboard-section">
      <div class="card dashboard-card bg-danger" style="border-radius: 0px 0px 15px 15px;">
        <div class="dashboard-title text-white mb-2">Spesifikasi Blow Out Preventer</div>
        <div class="tubular-specs">
          <label for="sn_bop" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Serial<input type="text" class="form-control" id="sn_bop" name="sn_bop" readonly></label>

          <label for="jenis_bop" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Jenis<input type="text" class="form-control" id="jenis_bop" name="jenis_bop" readonly></label>

          <label for="size" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Ukuran<input type="text" class="form-control" id="size" name="size" readonly></label>

          <label for="pressure" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Tekanan<input type="text" class="form-control" id="pressure" name="pressure" readonly></label>
          ...
          <label for="no_coc" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Nomor COC<input type="text" class="form-control" id="no_coc" name="no_coc" readonly></label>

          <label for="akhir_coc" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Masa COC<input type="text" class="form-control" id="akhir_coc" name="akhir_coc" readonly></label>
          
          <label for="status_coc" class="text-white mb-1" style="font-weight: bold; font-size: 0.75rem">Status COC<input type="text" class="form-control" id="status_coc" name="status_coc" readonly></label>
  ...
  <script>
      ...
      document.addEventListener('DOMContentLoaded', function () {
              ...
              if (snBOP) {
                  ...
                  fetch(`fct-astbopfedit.php?sn_bop=${snBOP}`)
                      ...
                      .then(data => {
                          ...
                          document.getElementById('akhir_coc').value = data.akhir_coc || '';
                          document.getElementById('status_coc').value = data.status_coc || '';
          ...
          function clearFields() {
              ...
              document.getElementById('sn_bop').value = '';
              document.getElementById('jenis_bop').value = '';
              document.getElementById('size').value = '';
              document.getElementById('pressure').value = '';
              document.getElementById('man').value = '';
              document.getElementById('type').value = '';
              document.getElementById('no_coc').value = '';
              document.getElementById('akhir_coc').value = '';
              document.getElementById('status_coc').value = '';
