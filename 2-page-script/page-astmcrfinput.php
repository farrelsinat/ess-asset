...
if(isset($_GET['edit'])){
  ...
  $query = "SELECT * FROM tb_dbhasilmcr WHERE id_mcr = '$id_mcr';";
  ...
  if($result = mysqli_fetch_assoc($sql)){
    ...
    $type = $result['type'];
    $man = $result['man'];
    $status = $result['status_mcr'];
    $noasset = $result['no_asset'];
    $nomov = $result['no_mov'];
    $nopo = $result['no_po'];
...
<head>
  ...
  <title>ESS | MUD CLEANER Input Data</title>
...
<body>
  ...
  <nav class="navbar navbar-second fixed-top" style="background-color: #198754;">
    <div class="container-fluid justify-content-center">
      <a class="navbar-brand text-white">INPUT DATA - MUD CLEANER</a>
    </div>
  </nav>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body"  style="font-size: 1rem;">
          <p class="text">Sebelum melakukan input data, mohon pastikan data unit MUD CLEANER yang akan dimasukkan belum ada pada database untuk menghindari terjadinya duplikasi data.</p>
          <p class="text">Data unit MUD CLEANER yang akan dimasukkan dapat diperiksa terlebih dahulu pada database, dengan mencari melalui Serial atau Nomor Movable.</p>
          <p class="text">Jika data unit MUD CLEANER tersebut tidak ditemukan pada database, data tersebut aman untuk dimasukkan.</p>
      </div>
  ...
  <div class="container">
    <div class="mb-3 row justify-content-center">
        <div class="card bg-warning mb-3" style="width: 90%; font-weight: bold; border-width: 0px;">
            ...
            <span class="text-center mt-2">Mohon hindari kesamaan Serial dari MUD CLEANER yang akan ditambahkan dengan yang sudah ada pada database.</span>
            <span class="text-center mt-2 mb-3">Jika telah melakukan input data, harap hubungi PIC.</span>
        </div>
    </div>
      <form id="dataForm" method="POST" action="pcs-astmcr">
          <input type="hidden" value="<?php echo $id_mcr; ?>" name="id_mcr">
          ...
          <div class="mb-3 row justify-content-center">
              <label for="sn_mcr" class="col-sm-2 col-form-label">Serial</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="sn_mcr" name="sn_mcr" placeholder="Cth: MA-023342">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="no_mov" name="no_mov" placeholder="Cth: 01.66.9301">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="type" name="type" placeholder="Cth: HYPERPOOL 4 PANEL">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="man" name="man" placeholder="Cth: DERRICK">
              </div>
          </div>
          
          <div class="mb-3 row justify-content-center">
              <label for="status_mcr" class="col-sm-2 col-form-label">Status Unit</label>
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="status_mcr" name="status_mcr" placeholder="Cth: ON SITE">
              </div>
          </div>
          ...
          <div class="mb-3 row justify-content-center">
              ...
              <div class="col-sm-5">
                  <input type="text" class="form-control" id="no_asset" name="no_asset" placeholder="Cth: 710009430">
              </div>
          </div>
          ...
          <div class="mb-3 row mt-4 justify-content-center">
              <div class="col-sm-5 d-flex justify-content-center">
                  ...
                  <a href="page-astmcrdtb.php" type="button" class="btn btn-danger">
